...
{
    internal class MyMigration : Migration
    {
        //The Up method is used to apply the changes to the database schema,
        //while the Down method is used to revert the changes.
